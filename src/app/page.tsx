        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-start gap-4 mb-4">
            <div className="flex-1">
              <h1 className="text-2xl md:text-3xl font-bold mb-2">IELTS Course by Munzereen Shahid</h1>
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                ...
                <br />
                Improve IELTS score today to achieve your desired band score with the guidance of the
                <br />
            ...
            <div className="flex-shrink-0">
              <Image
                src="/placeholder.svg?height=120&width=200&text=Course+Certificates"
                alt="Course certificates"
                width={200}
                height={120}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg border">
                <Image
                  src="/placeholder.svg?height=80&width=80&text=Instructor"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-1">IELTS Instructor, University of Oxford, UK</p>
                  <p className="text-sm text-gray-600 mb-1">M.A. (M.A English), University of Dhaka</p>
                  <p className="text-sm text-gray-600">B.A. (Hons English), University of Dhaka</p>
                </div>
              </div>
            </div>
